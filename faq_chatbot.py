...
print("Модель RuBERT скачивается...")
...
with custom_object_scope({'InputLayer': tf.keras.layers.Input}):
    model = tf.keras.models.load_model(MODEL_PATH)
    
while True:
    input_quest = input("Задайте вопрос FAQ-боту(или напишите 0 для выхода из программы): ")
    if input_quest.lower() == '0':
        break
    ...
    print(f"Ответ: {answers[best_match]}")
